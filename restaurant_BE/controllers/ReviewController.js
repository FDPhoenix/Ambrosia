...
exports.replyToReview = async (req, res) => {
    try {
        ...
        const getStarRating = (rating) => {
            return "⭐".repeat(rating); // Chỉ hiển thị số sao đánh giá
        };
        const mailOptions = {
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px; background-color: #f9f9f9;">
            <div style="text-align: center; margin-bottom: 20px;">
                <h1 style="color: #007bff;">Phản hồi từ Admin</h1>
                <p style="color: #555;">Chúng tôi đã nhận và phản hồi đánh giá của bạn!</p>
            </div>
            <div style="padding: 15px; background-color: #ffffff; border-radius: 5px; border: 1px solid #ddd;">
                <p style="color: #333; font-size: 16px;"><strong>Xin chào ${recipientName},</strong></p>
                <p style="color: #555; line-height: 1.6;">Cảm ơn bạn đã gửi đánh giá. Dưới đây là phản hồi từ chúng tôi:</p>
                <p style="color: #555; margin-top: 10px;"><strong>Đánh giá của bạn:</strong></p>
                ...
                <p style="color: #555; margin-top: 10px;"><strong>Phản hồi từ Admin:</strong></p>
                ...
                <p style="color: #555; line-height: 1.6; margin-top: 20px;">
                    Nếu bạn có bất kỳ thắc mắc nào, vui lòng liên hệ lại với chúng tôi qua email hoặc nhấn vào nút bên dưới để gửi yêu cầu hỗ trợ.
                </p>
                <div style="text-align: center; margin-top: 26px; margin-bottom: 20px;">
                    <a href="mailto:${process.env.EMAIL_USER}" style="background-color: #007bff; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">Liên hệ với chúng tôi</a>
                </div>
            </div>
            <footer style="text-align: center; margin-top: 30px; color: #999; font-size: 12px;">
                <p>© 2025 Ambrosia - Restaurant Management System. Mọi quyền được bảo lưu.</p>
                <p style="margin-top: 5px;">600 Nguyễn Văn Cừ Nối Dài, An Bình, Bình Thủy, Cần Thơ</p>
            </footer>
        </div>
    `,
        };
