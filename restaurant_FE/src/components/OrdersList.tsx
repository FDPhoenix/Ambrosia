          ...
          <div className="bg-white p-5 rounded-lg w-[90%] max-w-[600px] relative max-h-[90vh] overflow-y-auto scrollbar-hide">
            ...
            <div className="flex items-center mt-6 gap-10">
              ...
              <div
                ...
                className="flex-1 cursor-pointer border border-gray-300 py-2.5 px-4 text-center rounded-lg hover:bg-gray-100 transition select-none"
              >
                {selectedTemplate
...
>
  <div className="font-bold mb-2 text-center">{template.name}</div>

  {/* Đặt button trong div căn giữa */}
